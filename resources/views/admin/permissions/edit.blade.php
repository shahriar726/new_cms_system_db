                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                    <div class="flex p-2">
                        <a href="{{ route('admin.permissions.index') }}"
                           class="px-4 py-2 btn-outline-primary btn hover:bg-green-500 text-slate-100 rounded-md">Permission Index</a>
                    </div>
                        ...
                        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                            <form method="POST" action="{{ route('admin.permissions.update', $permission) }}">
                                ...
                                <div class="sm:col-span-6 pt-5">
                                    <button type="submit"
                                            class="px-4 py-2 btn btn-success hover:bg-green-700 rounded-md">Update</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="flex space-x-2 mt-4 p-2">
                            @if ($permission->roles)
                                @foreach ($permission->roles as $permission_role)
                                    <form class="px-4 py-2 b-500 hover:bg-red-700 text-white rounded-md" method="POST"
